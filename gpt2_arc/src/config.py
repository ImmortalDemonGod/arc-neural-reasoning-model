...
class TrainingConfig:
    ...
    num_workers: int = field(default_factory=lambda: multiprocessing.cpu_count() // 2 if multiprocessing.cpu_count() else 4, metadata={"description": "Number of worker threads for DataLoader."})
