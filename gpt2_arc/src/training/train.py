...
def main(args):
    ...
    try:
        ...
        if args.use_synthetic_data:
            ...
            logger.debug(f"Sample files: {synthetic_files[:5]}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-embd", type=int, default=32, help="Embedding dimension")
    ...
    parser.add_argument("--d-state", type=int, default=8, help="Mamba state dimension")
    parser.add_argument("--d-conv", type=int, default=2, help="Mamba convolution dimension")
